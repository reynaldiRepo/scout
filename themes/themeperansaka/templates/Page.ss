...
<head>
    ...
    <meta name="description" content="Official website dan Pusat Informasi Peran Saka Daerah Jawa Timur Tahun 2020 - Dikelola oleh DKD Jatim">
    ...
    <meta property="og:description" content="Official website dan Pusat Informasi Peran Saka Daerah Jawa Timur Tahun 2020 - Dikelola oleh DKD Jatim">
    ...
    <meta property="twitter:description" content="Official website dan Pusat Informasi Peran Saka Daerah Jawa Timur Tahun 2020 - Dikelola oleh DKD Jatim">
    ...
    <link rel="stylesheet" href="$ThemeDir/css/core.css">
    <link rel="stylesheet" href="$ThemeDir/assets/modules/owl/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="$ThemeDir/assets/modules/sweetalert/sweetalert2.min.css">
...
<body>
            ...
            <div class="container align-items-center">
                <div class="d-flex align-items-center justify-content-between">
                    <a href="https://www.dkdjatim.or.id" class="d-flex align-items-center">
                        <img src="https://cdn.dkdjatim.or.id/peran-saka-2020/png/colored/logo-vertical.png" class="py-2" style="height: 50px!important; width: auto!important" />
                    </a>
                    <div class="btn-group btn-group-sm d-lg-none align-items-center">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#navbar-navs" aria-expanded="false" aria-controls="navbar-navs">
        ...
        <div class="container py-5" id="heading-page">
            <div class="row">
                ...
                <div class="col-md-6 mt-5 mt-md-0">
                    <img src="$ThemeDir/assets/hero-min.png" alt="" class="img-fluid" />
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img src="https://cdn.dkdjatim.or.id/peran-saka-2020/svg/colored/logo-vertical.svg" class="img-thumbnail p-3 mb-3" />
            ...
            <div class="row justify-content-center">
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-bhayangkara.png" class="img-fluid" alt="SAKA Bhayangkara" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Saka Bhayangkara adalah Satuan Karya yang berada di bawah pembinaan Kepolisian Negara Republik Indonesia, Disamping itu Saka Bhayangkara merupakan Saka terbesar dan paling berkembang di Indonesia.',imageUrl: '/assets/saka-bhayangkara.png', imageAlt: 'Saka Bhayangkara', title: 'Satuan Karya Pramuka<br/>Bhayangkara',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-dirgantara.png" class="img-fluid" alt="SAKA Dirgantara" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Satuan Karya Pramuka Dirgantara adalah wadah kegiatan untuk meningkatkan pengetahuan dan keterampilan praktis di bidang kedirgantaraan guna menumbuhkan kesadaran untuk membaktikan dirinya dalam pembangunan nasional.',imageUrl: '/assets/saka-dirgantara.png', imageAlt: 'Saka Dirgantara', title: 'Satuan Karya Pramuka<br/>Dirgantara',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-wirakartika.png" class="img-fluid" alt="SAKA Wanabakti" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Saka atau Satuan Karya Pramuka Wira Kartika merupakan salah satu Satuan Karya Pramuka yang bersifat nasional. Saka yang dibentuk lewat kerjasama antara Kwartir Nasional dengan TNI Angkatan Darat ini bertujuan untuk mengembangkan pendidikan bela negara.',imageUrl: '/assets/saka-wirakartika.png', imageAlt: 'Saka Wira Kartika', title: 'Satuan Karya Pramuka<br/>Wira Kartika',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-wanabakti.png" class="img-fluid" alt="SAKA Wanabakti" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Satuan Karya Pramuka (Saka) Wanabakti adalah Satuan Karya dalam Gerakan Pramuka Indonesia yang memberikan bekal pengetahuan dan ketrampilan khusus di bidang kehutanan dan lingkungan hidup serta menanamkan rasa cinta dan tanggung jawab dalam mengelola sumberdaya alam.',imageUrl: '/assets/saka-wanabakti.png', imageAlt: 'Saka Wanabakti', title: 'Satuan Karya Pramuka<br/>Wanabakti',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-bakti-husada.png" class="img-fluid" alt="SAKA Bakti Husada" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Satuan Karya Pramuka Bakti Husada disingkat Saka Bakti Husada adalah wadah pengembangan pengetahuan, pembinaan keterampilan, penambahan pengalaman dan pemberian kesempatan untuk membaktikan dirinya kepada masyarakat dalam bidang kesehatan.',imageUrl: '/assets/saka-bakti-husada.png', imageAlt: 'Saka Bakti Husada', title: 'Satuan Karya Pramuka<br/>Bakti Husada',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-tarunabumi.png" class="img-fluid" alt="SAKA Taruna Bumi" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Satuan Karya Pramuka Tarunabumi adalah wadah bagi para Pramuka untuk meningkatkan dan mengembangkan kepemimpinan, pengetahuan, pengalaman, keterampilan dan kecakapan para anggotanya, sehingga mereka dapat melaksanakan kegiatan nyata dan produktif serta bermanfaat dalam mendukung kegiatan pembangunan pertanian.',imageUrl: '/assets/saka-tarunabumi.png', imageAlt: 'Saka Taruna Bumi', title: 'Satuan Karya Pramuka<br/>Taruna Bumi',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-pariwisata.png" class="img-fluid" alt="SAKA Pariwisata" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Saka Pariwisata merupakan wadah kegiatan pendidikan dan pembinaan guna menyalurkan minat, bakat dan menambah pengetahuan, ketrampilan, pengalaman para Pramuka Penegak dan Pandega, dalam bidang kepariwisataan.',imageUrl: '/assets/saka-pariwisata.png', imageAlt: 'Saka Pariwisata', title: 'Satuan Karya Pramuka<br/>Pariwisata',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-wbb.png" class="img-fluid" alt="SAKA Widya Bakti" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Saka Widya Budaya Bakti adalah wadah pendidikan dan pembinaan bagi para pramuka penegak dan pramuka pandega untuk menyalurkan minat, mengembangkan bakat, kemampuan, dan pengalaman dalam bidang pengetahuan dan teknologi serta keterampilan di bidang Pendidikan dan Kebudayaan yang dapat menjadi bekal bagi kehidupan dan penghidupannya untuk mengabdi pada masyarakat, bangsa, dan negara.',imageUrl: '/assets/saka-wbb.png', imageAlt: 'Saka Widya Budaya Bakti', title: 'Satuan Karya Pramuka<br/>Widya Budaya Bakti',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-kencana.png" class="img-fluid" alt="SAKA Kencana" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Saka Keluarga Berencana (Kencana) adalah wadah kegiatan dan pendidikan untuk meningkatkan pengetahuan keterampilan praktis dan bakti masyarakat, dalam bidang Keluarga Berencana, Keluarga Sejahtera dan Pengembangan Kependudukan.',imageUrl: '/assets/saka-kencana.png', imageAlt: 'Saka Kencana (Keluarga Berencana)', title: 'Satuan Karya Pramuka<br/>Kencana (Keluarga Berencana)',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-kalpataru.png" class="img-fluid" alt="SAKA Kalpataru" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Satuan Karya Pramuka (Saka) Kalpataru adalah Satuan Karya Pramuka di Gerakan Pramuka yang khusus bergerak dalam bidang cinta lingkungan hidup.',imageUrl: '/assets/saka-kalpataru.png', imageAlt: 'Saka Kalpataru', title: 'Satuan Karya Pramuka<br/>Kalpataru',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
                <div class="col-6 col-md-3 mb-3">
                    <div class="card border-0 card-body text-center">
                        <img src="$ThemeDir/assets/saka-bahari.png" class="img-fluid" alt="SAKA Bahari" />
                        <button class="btn btn-primary"
                            onclick="Swal.fire({text: 'Satuan Karya Bahari adalah wadah bagi Pramuka yang menyelenggarakan kegiatan-kegiatan nyata, produktif dan bermanfaat dalam rangka menanamkan rasa cinta dan menumbuhkan sikap hidup yang berorentasi kebaharian termasuk laut dan perairan dalam.',imageUrl: '/assets/saka-bahari.png', imageAlt: 'Saka Bahari', title: 'Satuan Karya Pramuka<br/>Bahari',  imageHeight: 200, imageWidth: 200});">Detail</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="alert alert-flicon alert-info">
                            ...
                            <div class="message-wrapper">
                                <h3>Infromasi</h3>
                                <p class="m-0">Kegiatan Peran SAKA akan segera hadir dan menyusul dan kami update nanti.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section id="mendaftar" style="background-color: rgba(52, 152, 219, .25);">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-3">
                    <a href="/comingsoon.html" class="btn btn-primary btn-block">Daftar Sekarang!<i
    ...
    <footer class="footer bg-dark py-3 text-white">
        <div class="container">
            <p class="copyright m-0 text-center">Hak Cipta 2020, <a class="text-white"
                    href="https://www.dkdjatim.or.id">Dewan Kerja Daerah Jawa Timur</a>. Created by <a
                    class="text-white" href="//www.iniadi.xyz">Amir Zuhdi Wibowo</a>.</p>
        </div>
    </footer>
    ...
    <script src="$ThemeDir/js/bootstrap.bundle.min.js"></script>

    <script src="$ThemeDir/assets/modules/owl/owl.carousel.min.js"></script>
    <script src="$ThemeDir/assets/modules/sweetalert/sweetalert2.all.min.js"></script>
    <script src="$ThemeDir/assets/modules/sweetalert/sweetalert2.min.js"></script>
