                                    ...
                                    <ul class="like-page-list-wrapper">
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-33.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                            ...
                                            <button class="like-button active">
                                                <img class="heart" src="$ThemeDir/images/icons/heart.png" alt="">
                                                <img class="heart-color" src="$ThemeDir/images/icons/heart-color.png"
                                                    alt="">
                                            </button>
                                        </li>
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-30.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-5.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-29.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                    ...
                                    <ul class="like-page-list-wrapper">
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-28.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-31.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-27.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-34.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-32.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="$ThemeDir/images/profile/profile-small-37.jpg"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="$ThemeDir/images/profile/profile-small-1.jpg"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-thumb-gallery">
                                    <figure class="post-thumb img-popup">
                                        <a href="$ThemeDir/images/post/post-large-1.jpg">
                                            <img src="$ThemeDir/images/post/post-1.jpg" alt="post image">
                                        </a>
                                    </figure>
                                </div>
                                <div class="post-meta">
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="$ThemeDir/images/profile/profile-small-9.jpg"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                                        ...
                                        <div class="col-8">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector"
                                                    href="$ThemeDir/images/post/post-large-2.jpg">
                                                    <img src="$ThemeDir/images/post/post-2.jpg" alt="post image">
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    <figure class="post-thumb">
                                                        <a class="gallery-selector"
                                                            href="$ThemeDir/images/post/post-large-3.jpg">
                                                            <img src="$ThemeDir/images/post/post-3.jpg"
                                                                alt="post image">
                                                        </a>
                                                    </figure>
                                                </div>
                                                <div class="col-12">
                                                    <figure class="post-thumb">
                                                        <a class="gallery-selector"
                                                            href="$ThemeDir/images/post/post-large-4.jpg">
                                                            <img src="$ThemeDir/images/post/post-4.jpg"
                                                                alt="post image">
                                                        </a>
                                                    </figure>
                                                </div>
                                                <div class="col-12">
                                                    <figure class="post-thumb">
                                                        <a class="gallery-selector"
                                                            href="$ThemeDir/images/post/post-large-5.jpg">
                                                            <img src="$ThemeDir/images/post/post-5.jpg"
                                                                alt="post image">
                                                        </a>
                                                    </figure>
                                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="$ThemeDir/images/profile/profile-small-4.jpg"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="$ThemeDir/images/profile/profile-small-8.jpg"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="$ThemeDir/images/profile/profile-small-2.jpg"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                                ...
                                <div class="post-thumb-gallery img-gallery">
                                    <div class="row no-gutters">
                                        <div class="col-6">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector"
                                                    href="$ThemeDir/images/post/post-large-6.jpg">
                                                    <img src="$ThemeDir/images/post/post-6.jpg" alt="post image">
                                                </a>
                                            </figure>
                                        </div>
                                        <div class="col-6">
                                            <figure class="post-thumb">
                                                <a class="gallery-selector"
                                                    href="$ThemeDir/images/post/post-large-7.jpg">
                                                    <img src="$ThemeDir/images/post/post-7.jpg" alt="post image">
                                                </a>
                                            </figure>
                                        </div>
                                    </div>
                        ...
                        <aside class="widget-area">
                                    ...
                                    <ul class="like-page-list-wrapper">
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-35.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-15.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                                        ...
                                        <li class="unorder-list">
                                            ...
                                            <div class="profile-thumb">
                                                <a href="#">
                                                    <figure class="profile-thumb-small">
                                                        <img src="$ThemeDir/images/profile/profile-small-6.jpg"
                                                            alt="profile picture">
                                                    </figure>
                                                </a>
                                            </div>
                            ...
                            <div class="card widget-item">
                                ...
                                <div class="widget-body">
                                    <div class="add-thumb">
                                        <a href="#">
                                            <img src="$ThemeDir/images/banner/advertise.jpg" alt="advertisement">
                                        </a>
                                    </div>
                                </div>
                            </div>
