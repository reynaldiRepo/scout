                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="author-into-list">
                            ...
                            <li><a><i class="fa-theme fa fa-building mr-1"></i>$CurrentMember.SakaData.Title</a></li>
                            <% else %>
                            <li><a><i class="fa fa-exclamation-triangle mr-1"></i> Isikan data saka</a></li>
                            <% end_if %>
                            <% if $CurrentMember.GolonganData %>
                            <li><a><i class="fa-theme fa fa-star mr-1"></i>$CurrentMember.GolonganData.Title</a></li>
                            <% else %>
                            <li><a><i class="fa fa-exclamation-triangle mr-1"></i> Isikan data Golongan</a></li>
                            <% end_if %>
                            <% if $CurrentMember.Kwarcab %>
                            <li><a><i class="fa-theme fa fa-home mr-1"></i>Kwarcab
                                    $CurrentMember.Kwarcab.getTitleShort()</a></li>
                            <% else %>
                            <li><a><i class="fa fa-exclamation-triangle mr-1"></i> Isikan data Kwarcab</a></li>
                            <% end_if %>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="author-into-list">
                            <li><a><i class="fa-theme fa fa-envelope mr-1"></i>$CurrentMember.Email</a></li>
                            <% if $CurrentMember.PhoneNumber %>
                            <li><a><i class="fa-theme fa fa-phone mr-1"></i>$CurrentMember.PhoneNumber</a></li>
                            <% else %>
                            <li><a><i class="fa fa-exclamation-triangle mr-1"></i> Isikan data Nomor Ponsel</a></li>
                            <% end_if %>
                            <% if $CurrentMember.TglLahir %>
                            <li><a><i class="fa-theme fa fa-calendar mr-1"></i>
                                    (Birthday) $CurrentMember.TglLahir.Format('dd-MM-Y')</a></li>
                            <% else %>
                            <li><a><i class="fa fa-exclamation-triangle mr-1"></i> Isikan data TGL Lahir</a></li>
                            <% end_if %>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <ul class="author-into-list">                            
                            ...
                            <li><a><i class="fa-theme fa fa-map mr-1"></i>$CurrentMember.Address</a></li>
                            <% else %>
                            <li><a><i class="fa fa-exclamation-triangle mr-1"></i> Isikan data Alamat</a></li>
                            <% end_if %>
                        </ul>
                    </div>
                </div>
        ...
        <div class="widget-body">
            <div class="about-author">
                <div class="list-group">
                    ...
                    <a href="$URL" class="list-group-item list-group-item-action"><i class="fa-theme $SosmedCategoryData.IconCode mr-2"></i>
                        $Username
                    </a>
                    <% end_loop %>
                    <% else %>
