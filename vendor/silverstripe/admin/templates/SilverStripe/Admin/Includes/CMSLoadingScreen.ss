<div class="ss-loading-screen">
    ...
    <h3 class="ss-loading-screen__text">
        Loading<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 3" width="10" height="3"
    ...
    <noscript>
        <p class="nojs-warning alert alert-warning">
            <%t SilverStripe\\Admin\\LeftAndMain.REQUIREJS 'The CMS requires that you have JavaScript enabled.' %></p>
    </noscript>
</div>
